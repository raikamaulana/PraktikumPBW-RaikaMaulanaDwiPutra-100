<?php include 'proses_index.php'; // Mengambil logika pencarian dan data?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <?php include 'nav.php'; // Menyertakan menu navigasi[cite: 3578]?>
        ...
        <form method="get" class="row g-3 mb-4">
            <div class="col-md-5">
                ...
                <input type="text" class="form-control" id="judul" name="judul" 
                       placeholder="Masukkan judul buku" value="<?php echo htmlspecialchars($search_judul) ?>">
            </div>
