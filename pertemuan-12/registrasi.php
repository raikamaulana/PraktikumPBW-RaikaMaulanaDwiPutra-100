...
<head>
    ...
    <title>Registrasi - Toko Buku Online</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .input-wrap:nth-child(1) { animation-delay: 0.50s; }
        .input-wrap:nth-child(2) { animation-delay: 0.60s; }
        .input-wrap:nth-child(3) { animation-delay: 0.70s; }
        ...
        /* password & confirm input punya toggle-pw di kanan */
        ...
        .match-hint.ok  { color: #5cb85c; }
        .match-hint.err { color: #e05c5c; }
        ...
        .btn-login {
            ...
            animation: fadeSlideUp 0.8s 0.82s cubic-bezier(.16,1,.3,1) both;
        }
        .btn-login::before {
            content: '';
...
<body class="noise">
    ...
    <div class="layout">
        ...
        <div class="left-panel">
            ...
            <div>
                <div class="big-text">Mulai<br>perjalanan<br>literasi<br>mu.</div>
            </div>
        ...
        <div class="right-panel">
            <div class="glass-card">
                ...
                <div class="text-center mb-6 stagger-1">
                    <p class="text-xs tracking-widest uppercase mb-2" style="color:var(--gold);letter-spacing:0.15em;">Buat Akun Baru</p>
                    <h1 class="font-display text-3xl font-light" style="color:var(--cream);line-height:1.1;">
                        Daftar<br><em>Sekarang</em>
                    </h1>
                ...
                <form method="post" action="" class="flex flex-col gap-4">
                    ...
                    <div class="input-wrap">
                        ...
                        <div style="position:relative;">
                            ...
                            <button type="button" class="toggle-pw" data-target="password" aria-label="Toggle password">
                                <svg class="eye-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <!-- Confirm Password -->
                    <div class="input-wrap">
                        <label for="cpassword" class="field-label">Konfirmasi Password</label>
                        <div style="position:relative;">
                            <svg class="field-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <button type="button" class="toggle-pw" data-target="cpassword" aria-label="Toggle confirm password">
                                <svg class="eye-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>
                                </svg>
                            </button>
                    ...
                    <!-- Submit -->
                    <button type="submit" name="submit" class="btn-login mt-2">
                        <span>Buat Akun</span>
                    </button>
                ...
                <div class="text-center mt-5 stagger-3">
                    ...
                    <p class="text-xs mb-2" style="color:rgba(245,240,232,0.35);letter-spacing:0.03em;">Sudah punya akun?</p>
                    <a href="login.php" style="color:var(--gold);font-size:0.82rem;letter-spacing:0.08em;text-transform:uppercase;text-decoration:none;font-weight:500;transition:color 0.3s;display:inline-flex;align-items:center;gap:6px;"
    ...
    <script>
        ...
        const segColors = ['#e05c5c', '#e08c3a', '#d4c44a', '#5cb85c'];
        ...
        const ICON_OK  = `<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`;
        const ICON_ERR = `<svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>`;

        function checkMatch() {
            const v1 = pwInput.value, v2 = cpwInput.value;
            if (!v2) { matchHint.innerHTML = ''; matchHint.className = 'match-hint'; return; }
            if (v1 === v2) {
                matchHint.innerHTML   = ICON_OK  + ' Password cocok';
                matchHint.className   = 'match-hint ok';
            } else {
                matchHint.innerHTML   = ICON_ERR + ' Password tidak cocok';
